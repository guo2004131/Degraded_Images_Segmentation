...
# files = glob.glob('/media/dg/4be9e114-dcd8-4062-9e39-880585e7fccd/Datasets/VOC/Processed_images/output/VOC_test_gt/*.png')
# files.sort()
# out_pth = '/media/dg/4be9e114-dcd8-4062-9e39-880585e7fccd/Datasets/VOC/Processed_images/output/processed'
# for f in files:
