...
%% do not change
out_pth = sprintf('/home/dg/Dropbox/Datasets/%s/Degraded_Images/Noise_Speckle', dataset);
...
train_out_folder = fullfile(out_pth, sprintf('degraded_parameter_%.2f/%s_train_images', sd, dataset));
test_out_folder = fullfile(out_pth, sprintf('degraded_parameter_%.2f/%s_test_images', sd, dataset));
