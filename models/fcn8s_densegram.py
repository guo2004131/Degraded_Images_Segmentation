...
class FCN8s(nn.Module):
    ...
    def __init__(self, n_class=21):
        ...
        self.conv2_2_b = nn.Conv2d(128, self.grow_rate, 1)
        self.conv2_2_b_ = nn.Conv2d(128, self.grow_rate, 1)
        ...
        self.conv3_b = nn.Conv2d(256, 64, 1)
    ...
    def forward(self, x):
        ...
        # conv2 h_
        h_ = self.relu2_1_(self.conv2_1_(h))
